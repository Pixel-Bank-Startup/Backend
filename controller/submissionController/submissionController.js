...
//     const testCases = problem.testCases || []; // Array: [{ input: "", expectedOutput: "" }, ...]
//     if (!testCases.length) {
...
//       const rawStdout = resp.stdout != null ? String(resp.stdout) : "";
//       const rawStderr =
//         resp.stderr != null
//           ? typeof resp.stderr === "string"
//             ? resp.stderr
//             : JSON.stringify(resp.stderr)
//           : "";
//       const rawCompile = resp.compile_output != null ? String(resp.compile_output) : "";
//       let userOutputSingle = rawStdout.trim();
//       if (!userOutputSingle) {
//         userOutputSingle = (rawStderr || rawCompile).trim();
//       }
